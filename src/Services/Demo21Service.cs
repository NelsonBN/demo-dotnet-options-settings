...
public interface IDemo21Service
{
    void Run();
}

public class Demo21Service : IDemo21Service
{
    ...
    public void Run()
    {
        ...
        _logger.LogInformation($"[SERVICE 21][1] {response1}");
        ...
        _logger.LogInformation($"[SERVICE 21][2] {response2}");
    }
}
