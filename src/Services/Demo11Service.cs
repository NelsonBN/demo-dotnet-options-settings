...
public interface IDemo11Service
{
    void Run();
}

public class Demo11Service : IDemo11Service
{
    ...
    public void Run()
    {
        ...
        _logger.LogInformation($"[SERVICE 11][1] {response1}");
        ...
        _logger.LogInformation($"[SERVICE 11][2] {response2}");
    }
}
